...
<template>
  <div>
    ...
    <form class="mt-1" @submit.prevent="login">
      <FormField v-slot="{ componentField }" name="email">
        <FormItem>
          ...
          <FormControl>
            <Input v-bind="componentField" id="email" type="email" placeholder="Enter email" required />
          </FormControl>
      ...
      <FormField v-slot="{ componentField }" name="password">
        <FormItem>
          ...
          <FormControl>
            <Input v-bind="componentField" id="text-password" type="password" aria-describedby="password-help-block" />
          </FormControl>
    ...
    <p>
      Don't have an account? <nuxt-link to="/users/register">
        Register
      </nuxt-link>
    </p>
  </div>
